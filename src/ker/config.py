...
def load_settings() -> Settings:
    ...
    return Settings(
        workspace=workspace,
        ker_root=ker_root,
        model_id=get("model_id", "MODEL_ID", "claude-sonnet-4-20250514"),
        ...
        heartbeat_enabled=get("heartbeat_enabled", "HEARTBEAT_ENABLED", "0") == "1",
        cron_enabled=get("cron_enabled", "CRON_ENABLED", "0") == "1",
        delivery_enabled=get("delivery_enabled", "DELIVERY_ENABLED", "0") == "1",
        kerweb_enabled=get("kerweb_enabled", "KERWEB_ENABLED", "0") == "1",
        kerweb_base_url=get("kerweb_base_url", "KERWEB_BASE_URL", "http://127.0.0.1:3000"),
